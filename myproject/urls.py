...
urlpatterns = [
    ...
    # when we hit root urls it will match the -pattern here
    # After matching, it will chop off the root url
    # and send the remaining string.
    # for example in case of <root url>/about, 
    # it will chop root url and send string "about"
    # to application urls that is blog.urls.
    path('', include('blog.urls')),
    path('register/', user_views.reister, name='register'),
